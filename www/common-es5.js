...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /*! exports provided: MustMatch, CheckAmount */

  /***/
  function srcAppServicesHelperTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CheckAmount", function () {
      return CheckAmount;
    });
    /* harmony import */
    ...
    function MustMatch(controlName, matchingControlName) {
      return function (formGroup) {
        var password = controlName;
        var passwordConfirm = matchingControlName;
        var control = formGroup.get('password');
        var matchingControl = formGroup.get('passwordConfirm');
